...
- Po awarii Gerbery wywołanej zniknięciem plików eksportu usługa ma sama próbować wstać ponownie z backoffem `10 s`, potem `1 min`, a od trzeciej próby `30 min`; przed każdą automatyczną próbą trzeba usunąć połamane symlinki z `/dlna`, żeby restart miał szansę się utrzymać.
